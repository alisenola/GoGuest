                ...
                <form role="form" action="<?php echo base_url()."subcategory/update" ?>" method="post" enctype="multipart/form-data" >
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="cat_id">
                          <?php for($i=0;$i<count($category);$i++) {
                              if($category[$i]['categoryid'] == $sub_category[0]['categoryparentid'])
                              {
                              ...
                              ?>
                          <option <?php echo $sel; ?> value="<?php echo $category[$i]['categoryid']; ?>"><?php echo $category[$i]['categoryname']; ?></option>
                        <?php } ?>
                      </select>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="subcat_name" name="subcat_name" value="<?php echo $sub_category[0]['categoryname']; ?>">
                    </div>
                  ...
                  <div class="box-footer">
                      <input type="hidden" name="categoryid" value="<?php echo $sub_category[0]['categoryid']; ?>" >
