...
<!-- Content Wrapper. Contains hotel content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1><?php echo $lang->language['sub_category']; ?></h1>
          <ol class="breadcrumb">
              <li><a href="<?php echo base_url(); ?>"><i class="fa fa-dashboard"></i> <?php echo $lang->language['home']; ?></a></li>
            <li class="active"><?php echo $lang->language['sub_category']; ?></li>
          </ol>
              ...
              <div class="box">
                ...
                <div class="box-body">
                 ...
                 <?php if(count($subcategories)>0){ ?>
                    ...
                    <thead>
                      <tr>
                        <th><?php echo $lang->language["sub_category"];  ?></th>
                        <th><?php echo $lang->language["parent_catname"];  ?></th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><?php echo $subcategories[$i]['categoryname']; ?></td>
                        <td><?php echo $subcategories[$i]['parentcatname']; ?></td>
