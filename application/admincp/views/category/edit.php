 ...
 <!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <?php echo $lang->language["edit"];  ?> <?php echo $lang->language["category"];  ?>
            
          </h1>
          <ol class="breadcrumb">
              <li><a href="<?php echo base_url(); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="<?php echo base_url()."category"; ?>">Hotels</a></li>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" action="<?php echo base_url()."category/update" ?>" method="post" enctype="multipart/form-data" >
                  <div class="box-body">
                    <div class="form-group">
                      <label for=""><?php echo $lang->language["category_name"];  ?></label>
                      <input type="text" class="form-control" id="name" name="name" value="<?php echo $category[0]['categoryname']; ?>">
                    </div>
                    
                  </div><!-- /.box-body -->

                  <div class="box-footer">
                      <input type="hidden" name="categoryid" value="<?php echo $category[0]['categoryid']; ?>" >
                      
                      <input type="submit" class="btn btn-primary" value="<?php echo $lang->language["update"];  ?>">
                      <a class="btn btn-default" href="<?php echo base_url('category'); ?>"><?php echo $lang->language['cancel']; ?></a>
                  </div>
                </form>
              </div><!-- /.box -->
