  ...
  <body class="skin-yellow sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="<?php echo base_url('hotel') ?>" class="logo">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Welcome <?php echo $this->session->userdata['goguest_session'][2]; ?></span>
                </a>
...
<!--              <li class="dashboard">
            ...
            <li class="hotel">
                ...
                <i class="fa fa-hotel"></i> <span><?php echo $lang->language['hotels']; ?></span>
              </a>
            </li>
            <li class="hoteladmin">
                <a href="<?php echo base_url('hoteladmin') ?>">
                <i class="fa fa-user"></i> <span><?php echo $lang->language['hotel_admin']; ?></span>
              </a>
            </li>
            <li class="category">
                <a href="<?php echo base_url('category') ?>">
                <i class="fa fa-briefcase"></i> <span><?php echo $lang->language['category']; ?></span>
              </a>
            </li>
            <li class="subcategory">
                <a href="<?php echo base_url('subcategory') ?>">
                <i class="fa fa-briefcase"></i> <span><?php echo $lang->language['sub_category']; ?></span>
              </a>
            </li>
<!--            <li class="request">
            ...
            <li class="user">
                ...
                <i class="fa fa-user"></i> <span><?php echo $lang->language['user']; ?></span>
              </a>
            </li>
<!--            <li class="feedback">
            ...
            <li class="userresponse">
                <a href="<?php //echo base_url('userresponse') ?>">
                <i class="fa fa-stack-exchange"></i> <span><?php //echo $lang->language['user_checkin_checkout']; ?></span>
              </a>
            </li>-->
