...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><?php echo $lang->language["hotel_user"]; ?></h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active"><?php echo $lang->language["hotel_user"]; ?></li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <a href="<?php echo base_url('hoteladmin/add'); ?>" class="btn btn-primary pull-right"><?php echo $lang->language['hotel_user_add']; ?></a>
                        <?php if (count($hoteluser) > 0) { ?>
                            <table id="example2" class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        <th>
                                            <?php echo $lang->language["hotel_user_name"]; ?>            		 
                                        </th>
                                        <th>
                                            <?php echo $lang->language["hotel_user_email"]; ?>            		 
                                        </th>
                                        <th>
                                            <?php echo $lang->language["action"]; ?>            		 
                                        </th>
                                ...
                                <tbody>
                                    <?php for ($i = 0; $i < count($hoteluser); $i++) { ?>
                                        <tr>
                                            <td><?php echo $hoteluser[$i]['username']; ?></td>
                                            <td><?php echo $hoteluser[$i]['useremail']; ?></td>


                                            <td>
                                                <a href="<?php echo site_url('hoteladmin/edit/' . base64_encode($hoteluser[$i]['huid'])); ?>" class="btn btn-primary" title="Edit"><i class="glyphicon glyphicon-edit"></i></a> 
                                                <a href="<?php echo site_url('hoteladmin/delete/' . base64_encode($hoteluser[$i]['huid'])); ?>" class="btn btn-danger" title="Delete" onClick="return confirm('Are you sure you want to delete this hotel user?');"><i class="glyphicon glyphicon-remove"></i></a> 
                                            </td>
